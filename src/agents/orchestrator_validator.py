...
from src.agents.prompts import ORCHESTRATOR_SYSTEM_MESSAGE, VALIDATOR_SYSTEM_MESSAGE
from src.tools.tools import StockInfoTool, StockForecastTool, SentimentAnalysisTool, FinancialLiteracyTool, PortfolioOptimizationTool, OptionsPricingTool, StockScreenerTool, SavingsGoalTool
...
class OrchestratorAssistantAgent(RoutedAgent):
    ...
    async def validate_tool_responses(self, tool_responses: list[dict], message: str, context: list[LLMMessage], conversation_id: str) -> bool:
        ...
        for tool_response in tool_responses:
            ...
            validation_task = self.get_shield_task("tools", tool_response["name"])
